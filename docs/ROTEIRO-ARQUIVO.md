# ROTEIRO — ARQUIVO (o histórico completo até 04/08/2026)

> **O que é este arquivo.** É o `docs/ROTEIRO.md` **inteiro**, como estava antes
> da poda de 04/08/2026 — 8182 linhas, um ano de decisões, relatos de
> construção e discussões. Nada foi perdido: o que saiu do roteiro vivo está
> aqui, com a numeração original das seções (§4.1, §4.32, §4.97…).
>
> **Não é leitura de rotina.** Abra só para consultar o passado: por que uma
> tela foi construída de tal jeito, o que foi discutido em tal dia, a redação
> completa de uma seção que hoje vive resumida em uma linha.
>
> **O que vale hoje está em `docs/ROTEIRO.md`** — decisões em vigor, ideias
> rejeitadas que continuam rejeitadas, pendências em aberto e apurações caras.
>
> **Não escreva aqui.** Decisão nova vai para o `ROTEIRO.md`.
