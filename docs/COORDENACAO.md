...
|---|---|---|---|---|
| A · voz `pm_alex` · aba 🟢 | — livre — (última tarefa: §4.103, 2ª rodada — o Menu absorveu o `/you`). ⚠️ **B/C, dois recados que mudam texto de tela:** (1) a aba de baixo agora se chama **"Feed"**, não "Comunidade" — a palavra *comunidade* vale **só para os fóruns** (`/forum`), porque o mesmo nome levava a duas telas; ao escrever texto que cite a aba, é "Feed"; (2) `/you` virou **"Configurações"** e só tem ajustes — notas, trechos, downloads, estatísticas e conquistas moram no **Menu** do hambúrguer. Some também o cartão vermelho de sala ao vivo e a bolinha do hambúrguer. | — | não — serviço launchd sempre no ar | 05/08 |
