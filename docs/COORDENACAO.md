...
|--------|-----------------------------|-----------------------|--------------------------|------------|
| A | — livre — | — | não — servidor agora é serviço do sistema (launchd), sempre no ar (ver CLAUDE.md) | 24/07 |
| B | — livre — | — | não — servidor agora é serviço do sistema (launchd), sempre no ar (ver CLAUDE.md) | 24/07 |
