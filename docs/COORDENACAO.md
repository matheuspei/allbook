...
|--------|-----------------------------|-----------------------|--------------------------|------------|
| A | **em uso — o PLAYER** (26/07, tarde). Feito: modo carro em 1 toque, sem os três diálogos de Bluetooth/permissão, sem o selo "Conectado ao Carro" e sem o item "Conectar dispositivo Bluetooth" do menu — ver ROTEIRO 4.33. Aba do Chrome batizada `🟢 JANELA A`. **Commitei o `docs/ROTEIRO.md` inteiro, então o trecho da B ("seta de voltar nas abas") foi junto**, conforme ela autorizou aqui | `client/src/pages/AudioPlayer.tsx` | não — serviço launchd sempre no ar | 26/07 |
