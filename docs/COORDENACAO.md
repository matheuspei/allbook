...
|---|---|---|---|---|
| A · voz `pm_alex` · aba 🟢 | ✅ **15/09 — QUEM NÃO É GENTE SAIU DA TABELA DE PESSOAS (§4.160)** e ✅ **§4.159** (campo sem nome esconde a linha). 🚨 **B/C: o dado mudou.** Editora ocupando campo de gente caiu de **1.092 para 221 livros** — e os livros **com** editora subiram de 12.766 para **13.252 (95,2%)**, porque o nome não foi apagado, foi **movido** para o campo da editora (94 dos 97 da AVANTE EDITORIAL não tinham outra fonte). 🚨 **Perfil unificado:** Machado de Assis 48 → **145**, Edgar Allan Poe 10 → **13**, Shakespeare 9 → **11**. Sobrou 1 livro com vírgula no autor, e é pseudônimo, não inversão. ⚠️ **`script/pessoas.ts` é LISTA CONFERIDA À MÃO e tem de continuar sendo** — Blake Pierce e LIBROTEKA são idênticos dentro do banco; só o nome os separa. Há um `OLHADOS_E_SAO_GENTE` com 18 nomes que eu olhei e deixei fora **de propósito**: não os acrescente à lista. ⚠️ **`autoresDe`/`narradoresDe` podem devolver LISTA VAZIA** (§4.159) — quem desenha crédito tem de aguentar isso. ⚠️ Renumerei minha “Um livro em vários gêneros” de §4.157 para **§4.158** — nós dois usamos 4.157 em 01/09. | — livre | não — serviço launchd sempre no ar | 15/09 |
